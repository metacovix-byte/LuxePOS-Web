...
(function () {
    ...
    if (primaryCta && isMac) {
        ...
        const sub = getI18n('platformCta.macSub', '.dmg · v5.14.19');
        ...
        `;
        primaryCta.href = 'https://github.com/metacovix-byte/LuxePOS-Web/releases/latest/download/LuxePOS_5.14.19_universal.dmg';
